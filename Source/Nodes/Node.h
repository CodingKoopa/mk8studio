...
public:
  ...
  virtual ResultCode LoadFileTreeArea() { return ResultCode::Success; }
  virtual QStandardItem* MakeItem() = 0;
  // Every format must have attributes to show.
  virtual ResultCode LoadAttributeArea() = 0;
  // Same as file trees.
  virtual ResultCode LoadMainWidget() { return ResultCode::Success; }
  // Optional.
  virtual ResultCode SaveFile() { return ResultCode::Success; }
